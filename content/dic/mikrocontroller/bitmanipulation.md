...
## Beispiel 1
Im Register PORTC soll das Bit 5 auf 0 gesetzt werden, die anderen sollen ihren Zustand behalten:
...
## Beispiel 2
Eine Anweisung soll nur ausgeführt werden, wenn Bit 1 im Register `PINA` auf 1 ist. Bei if wird immer der True Zweig ausgeführt, wenn die Bedingung ungleich 0 ist.
